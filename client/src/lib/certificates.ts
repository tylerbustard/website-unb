...
export const certificateAssets: Record<string, CertificateAsset> = {
  ...
  "bloomberg-market-concepts": { image: "/certificates/bloomberg-market-concepts-certificate.webp", alt: "Bloomberg Market Concepts certificate from Bloomberg" },
  ...
  "ai-fluency--framework-and-foundations": { image: "/certificates/ai-fluency--framework---foundations.webp", alt: "AI Fluency: Framework and Foundations certificate from Anthropic" },
...
// listed button-adds
  ...
  "learn-sql-basics-for-data-science": { image: "/certificates/sql-for-data-science.webp", alt: "Learn SQL Basics for Data Science certificate from UC Davis" },
  ...
  "econometrics--methods-and-applications": { image: "/certificates/econometrics--methods---applications.webp", alt: "Econometrics: Methods and Applications certificate from Erasmus University Rotterdam" },
